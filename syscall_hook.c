...
DECLARE_OUR_SYSCALL_TABLE(440)
DECLARE_OUR_SYSCALL_TABLE(441)
DECLARE_OUR_SYSCALL_TABLE(442)
DECLARE_OUR_SYSCALL_TABLE(443)
DECLARE_OUR_SYSCALL_TABLE(444)
DECLARE_OUR_SYSCALL_TABLE(445)
DECLARE_OUR_SYSCALL_TABLE(446)
DECLARE_OUR_SYSCALL_TABLE(447)
DECLARE_OUR_SYSCALL_TABLE(448)
DECLARE_OUR_SYSCALL_TABLE(449)
DECLARE_OUR_SYSCALL_TABLE(450)
DECLARE_OUR_SYSCALL_TABLE(451)
DECLARE_OUR_SYSCALL_TABLE(452)
...
static void gen_our_syscall(void)
{
    ...
    ASSIGN_OUR_SYSCALL_TABLE(440);
    ASSIGN_OUR_SYSCALL_TABLE(441);
    ASSIGN_OUR_SYSCALL_TABLE(442);
    ASSIGN_OUR_SYSCALL_TABLE(443);
    ASSIGN_OUR_SYSCALL_TABLE(444);
    ASSIGN_OUR_SYSCALL_TABLE(445);
    ASSIGN_OUR_SYSCALL_TABLE(446);
    ASSIGN_OUR_SYSCALL_TABLE(447);
    ASSIGN_OUR_SYSCALL_TABLE(448);
    ASSIGN_OUR_SYSCALL_TABLE(449);
    ASSIGN_OUR_SYSCALL_TABLE(450);
    ASSIGN_OUR_SYSCALL_TABLE(451);
    ASSIGN_OUR_SYSCALL_TABLE(452);
}
